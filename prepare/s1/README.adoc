...
- link:p09_merge_intervals/Problem.adoc[merge overlapping intervals] by sorting for starting time
- link:p10_group_anagrams/Problem.adoc[group anagrams together] categorize by string / count
